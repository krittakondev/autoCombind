...
class run_program(GUI):
    ...
    def main_gui(self):
        ...
        upImage = tkinter.PhotoImage(file=os.path.join(self.MAIN_PATH, "assets/up.png"))
        upImage = upImage.subsample(25,25)
        downImage = tkinter.PhotoImage(file=os.path.join(self.MAIN_PATH, "assets/down.png"))
